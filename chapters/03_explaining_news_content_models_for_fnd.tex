...
answer questions like these and more,~\cite{AUnifiedApproach_Lundberg} (\citeyear{AUnifiedApproach_Lundberg}) proposes a unified framework in which any model (except GNNs) can be explained.\\
