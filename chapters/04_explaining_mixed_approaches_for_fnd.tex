...
\begin{figure}
    ...
    \hfill
    \subfloat[The explanation provided for the second real news instance]{\includegraphics[width=0.45\textwidth]{POL_RealNewsExample2Explanation_no_threshold.png}}
    \hfill
    \subfloat[The explanation with median method applied]{\includegraphics[width=0.45\textwidth]{POL_RealNewsExample2Explanation_with_threshold_median.png}}
    \hfill
    \subfloat[The explanation with mean method applied]{\includegraphics[width=0.45\textwidth]{POL_RealNewsExample2Explanation_with_threshold_mean.png}}
