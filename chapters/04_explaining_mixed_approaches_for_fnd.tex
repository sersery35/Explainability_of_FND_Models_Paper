...
\begin{figure}
    \centering
    \includegraphics[scale=0.35]{EchoChamberExample1}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.35]{POL_RealNewsExample1}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.35]{GOS_FakeNewsExample1}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.35]{GOS_FakeNewsExample1Perturbed}
